...
class InvoicesApiService extends BaseApiService {
  InvoicesApiService({httpClient}) : super(httpClient);

  Future<InvoicesResponse> invoicesList({final int? pageNo}) async {
    // Building query
    final uri = getUri('/m/api/getHostTaxInvoices');
