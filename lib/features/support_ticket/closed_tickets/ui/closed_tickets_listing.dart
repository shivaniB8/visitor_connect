...
import 'package:host_visitor_connect/features/support_ticket/closed_tickets/ui/list_item_closed_ticket.dart';
...
class ClosedTicketListing extends StatefulWidget {
  final List<Ticket> tickets;
  // final FiltersModel? filters;

  const ClosedTicketListing({
    Key? key,
  ...
  @override
  State<ClosedTicketListing> createState() => _ClosedTicketListingState();
}

class _ClosedTicketListingState extends State<ClosedTicketListing> {
  late ClosedTicketBloc _ticketBloc;
  ...
  @override
  void initState() {
    _ticketBloc = context.read<ClosedTicketBloc>();
...
class _NextPageLoader extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final ticketBloc = context.read<ClosedTicketBloc>();
