...
class TitlesBloc extends Cubit<UiState<KeyValueListResponse>> {
  final UserRepository _userRepository;

  TitlesBloc({UserRepository? userRepository})
      : _userRepository = userRepository ?? UserRepository(),
        super(Default());

  Future getTitles() {
    emit(Progress());
    return _userRepository.getTitles().then(_onSuccess).handleError(_onError);
  }
