...
class RentApiService extends BaseApiService {
  RentApiService({httpClient}) : super(httpClient);
  ...
  Future<PageResponse<VisitorRoomResponse>> rentedListing({
    ...
    // Building query
    final uri = getUri(GlobalVariable.selectedCarRental == 0
        ? '/m/api/getCurrentCarRentalVisitorHistory'
        : '/m/api/getCarRentalVisitorHistory');
    ...
    final body = jsonEncode({
      ...
      "ae1": SharedPrefs.getInt(keyBranch) ?? 1,
    });
