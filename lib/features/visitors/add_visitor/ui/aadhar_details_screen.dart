                          ...
                          child: Column(
                            ...
                            children: [
                                      ...
                                      if (!(widget.isForeigner ?? false))
                                        Text(
                                          capitalizedString(widget
                                                  ...
                                                  ?.aadharName ??
                                              'Not Available'),
                                          style: text_style_title4.copyWith(
                                              color: Colors.black),
                                        ),
                                      if ((widget.isForeigner ?? false))
                                        Text(
                                          capitalizedString(
                                              widget.foreignerData?.fullName ??
                                                  'Not Available'),
                                          style: text_style_title4.copyWith(
                                              color: Colors.black),
                                        ),
                              ...
                              widget.otpVerified ?? false
                                  ? const SizedBox
                                      .shrink() // if verified, show empty box
                                  : SizedBox(
                                      height: 50,
                                      width: MediaQuery.of(context).size.width,
