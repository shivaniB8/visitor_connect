...
import 'package:host_visitor_connect/features/visitors/add_visitor/ui1/otp_verification_builder.dart';
...
import 'aadhar_photo_screen.dart';
import 'add-aadhar_provider.dart';
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            PinFieldAutoFill(
                              ...
                              enabled: (context.watch<AadharDetailsBloc>().state
                                          is! Progress) &&
                                      (!_otpIsWrongDisableTextField &&
                                          !otpIsWrongDisable)
                                  ? true
