...
import 'package:host_visitor_connect/features/visitors/visitor_listing/ui/swiperPluginCode/lib/src/flutter_page_indicator/flutter_page_indicator.dart';
import 'package:host_visitor_connect/features/visitors/visitor_listing/ui/swiperPluginCode/lib/src/swiper_controller.dart';
import 'package:host_visitor_connect/features/visitors/visitor_listing/ui/swiperPluginCode/lib/src/swiper_pagination.dart';
import 'package:host_visitor_connect/features/visitors/visitor_listing/ui/swiperPluginCode/lib/src/swiper_plugin.dart';
import 'package:host_visitor_connect/features/visitors/visitor_listing/ui/swiperPluginCode/lib/src/transformer_page_view/index_controller.dart';
...
class _TinderState extends _CustomLayoutStateBase<_TinderSwiper> {
  ...
  @override
  Widget _buildItem(int i, int realIndex, double animationValue, List<Widget> list) {
            ...
            margin: EdgeInsets.only(
                left: widget.axisDirection == AxisDirection.left
                    ? list.isEmpty
                        ? 0
                        : 25
                    : 0, // customize here only
                right: widget.axisDirection == AxisDirection.right
                    ? list.isEmpty
                        ? 0
                        : 25
                    : 0), // customize here only
            width: double.infinity, // customize here only
            // height: widget.itemHeight ?? double.infinity,//customize here only
            child: widget.itemBuilder!(context, realIndex),
          ),
        ),
      ),
