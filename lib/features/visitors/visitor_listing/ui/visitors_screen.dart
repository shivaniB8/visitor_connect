...
import 'package:host_visitor_connect/features/visitors/visitor_listing/ui/visitors_listing_fragment.dart';
  ...
  void _onSearch(String query) {
    ...
    if (_isSelected == "guest") {
      context
          ...
          .getVisitorsGrouping(pageNo: 0, searchTerms: _searchQuery);
    } else {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              showModalBottomSheet(
                ...
                builder: (_) {
                  return MultiProvider(
                    ...
                    child: ListFilter(
                      isFromVisitor: _isSelected == 'guest' ? true : false,
          ...
          if (businessType == "1,2")
            IgnorePointer(
              ignoring: context.watch<VisitorsGroupingBloc>().state is Progress ||
      ...
      child: Hero(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Text(
              text,
              style: AppStyle.titleMedium(context).copyWith(color: textColor),
            ),
          ),
        ),
      ),
